...
// أزرار التنقل
document.getElementById('to-account-details')?.addEventListener('click', function() {
    // الانتقال الفوري بدون تأخير من showScreen
    ...
    // إظهار إشارة التحميل في منتصف صندوق كشف الحساب
    ...
    if (accContent) {
        ...
        // إدراج الloader قبل جدول الحركات
        if (tableContainer) {
    ...
    // بعد 3 ثواني إخفاء التحميل وإظهار الحركات
    setTimeout(() => {
...
/***********************
 * شاشة "إنشاء USSD QR" (كاملة الصفحة) — تُفتح من صورة عن محفظتي
 ***********************/
...
/***********************
 * شاشة "عن بال باي" (كاملة الصفحة) — تُفتح من أيقونة الاتصال الصغيرة
 ***********************/
(function initAboutUsScreen() {
    const trigger = document.getElementById('about-us-icon-trigger');
